...
des:
    the script is the most same to swatnet_infer.py. this script is used for comparason with 
    the baseline models, including single model (deeplabv3+) and scales model.
example:
    same to the swatnet_infer_baseline.py
'''
...
path_swatnet_w = ['model/trained_model/gscales/dset/as_des/model_1_weights.pth']
path_swatnet_w_as = ['model/trained_model/gscales/traset/as/model_1_weights.pth']
path_swatnet_w_des = ['model/trained_model/gscales/traset/des/model_1_weights.pth']
...
if __name__ == '__main__':
    ...
    '''Model loading'''
    if 'single' in path_swatnet_w:
        model = deeplabv3plus(num_bands=4, num_classes=2)
    elif 'scales' in path_swatnet_w:
