...
// Map.setCenter(101.04, 33.73, 13);
// Map.setCenter(94.51, 27.08, 13);
// Map.setCenter(86.51, 30.90, 13);
var scene_region = ee.Geometry.Rectangle(97.93, 34.62, 98.35, 34.93);
var scene_outline = empty.paint({
    featureCollection: scene_region, color: 1, width: 3});


Map.addLayer(image_l8, {bands: ['B5', 'B4', 'B3'], min:0, max:3000}, 'Landsat 8')
Map.addLayer(sen2, {bands: ['B8', 'B4', 'B3'], min: 0, max: 3000}, 'sen2');
